  ...
  return (
    <div className="lesson-mode">
      ...
      <div className="lesson-mode__cards">
        <Link
          to={`/${level}/lektion/${lessonId}/flashcards`}
          className="lesson-mode__card"
        >
          <div className="lesson-mode__header">
            <div className="lesson-mode__img">
              <img
                src={flashcardsIcon}
                alt="Flashcards"
                className="lesson-mode__icon"
              />
            </div>
          </div>
          <div className="lesson-mode__body">
            <div className="lesson-mode__label">{t("flashcards")}</div>
            <div className="lesson-mode__bar">
              <div
                className="lesson-mode__progress"
                style={{ width: `${flashcardsProgress}%` }}
              ></div>
            </div>
            <div className="lesson-mode__text">
              {learnedFlashcards} {t("of")} {totalWords}
            </div>
          </div>
        </Link>

        <Link
          to={`/${level}/lektion/${lessonId}/articles`}
          className="lesson-mode__card"
        >
          <div className="lesson-mode__header">
          ...
          <div className="lesson-mode__body">
            <div className="lesson-mode__label">{t("articles")}</div>
            <div className="lesson-mode__bar">
              <div
                className="lesson-mode__progress"
            ...
            <div className="lesson-mode__text">
              {learnedArticles} {t("of")} {totalWithArticles}
            </div>
          </div>
        </Link>
      </div>
